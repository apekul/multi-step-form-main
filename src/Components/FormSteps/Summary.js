...
const Summary = ({
  ...
  return (
    <section className="bg-white w-auto sm:h-full flex flex-col pb-5 pt-6 sm:pt-10 px-6 sm:px-[2rem] lg:px-[6rem] sm:bg-none m-3 sm:m-0 rounded-xl sm:rounded-none shadow-md sm:shadow-none absolute -top-[5.5rem] left-0 right-0 sm:static">
      {/* <section className="w-auto sm:h-full flex flex-col pb-3 sm:pb-5 pt-6 sm:pt-10 px-6 sm:px-[2rem] md:px-[6rem] bg-white sm:bg-none m-3 sm:m-0 rounded-xl sm:rounded-none shadow-md sm:shadow-none absolute -top-[5.5rem] left-0 right-0 sm:static"> */}
